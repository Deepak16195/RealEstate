...
public class PenCardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pen_card);
        initView();
        FrontSideImage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ClickedData ="FrontSideImage";
                if (PermissionUtility.checkPermissionCameraAccessAndReadExternalStorage(PenCardActivity.this)) {
                    //showPictureDialog();
